...
### Added
- **ArenaFrames**: 새 모듈 추가 — 아레나 적 프레임 스케일 및 간격 조절
- **ArenaFrames**: Scale 슬라이더 — CompactArenaFrame 전체 크기 조절 (50~200%)
- **ArenaFrames**: Frame Spacing 슬라이더 — 적 프레임 간 픽셀 간격 조절 (0~30px)
